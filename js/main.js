;(function () {
    ...
    var scrollDown = function(){
		...
		$('#cible').click(function(){
            var page = (".target")
	$('html, body').animate({
		scrollTop:$(page).offset().top}, 500,'easeInOutExpo');
	return false;
});
	};
    
    var overlayUp = function(){
    ...
    var sendMail = function(){
        $("#dl").click(function(){
            ...
            $.ajax({
                ...
                type : 'post',
                data:'email='+document.getElementById('azertymail').value,
                dataType : 'text',
                success : function(code_html, statut){
                    
                    
                    $("#resultat").html("<p>Le fichier se télécharge</p>");
                },
   ...
   var test = function()
{
   ...
   oA.onclick = function()
   {
        ...
        $.ajax({
            ...
            data:'song_name='+document.getElementById('test').href,
            dataType : 'text',
            success : function(code_html, statut){
                },
                error : function(resultat, statut, erreur){
